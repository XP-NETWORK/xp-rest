...
import { EthNftInfo, NftInfo, TronHelper, TronParams, Web3Helper, Web3Params } from "xp.network";
import { Singleton } from "../singletons";


export interface ApproveService {
  approve: (nonce: number, address: NftInfo<EthNftInfo>, privateKey: string) => Promise<boolean>
}
